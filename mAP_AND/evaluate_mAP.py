...
DR_PATH = 'C:/Users/might/Dropbox (GaTech)/Shared folders/AND_Project/testing_images/untouched_input/0.35iou/histEq_aug1050redo/' #os.path.join(os.getcwd(), 'untouched_input', 'detection-results_uNet_uIm')
...
root_output_path = 'C:/Users/might/Dropbox (GaTech)/Shared folders/AND_Project/testing_images/evaluation/0.35iou/'
# HistEq INPUT
...
output_files_path = root_output_path + "output-histEq_aug825redo-untouch_input"
...
# output_files_path = root_output_path + "output-untouch_825-untouch_input"
# output_files_path = root_output_path + "output-untouch_1050-untouch_input"
